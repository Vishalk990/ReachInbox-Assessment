...
export const EmailItem = ({
  ...
  <div className="flex flex-col border-b border-[#FFFFFF] px-2 py-2 rounded-sm hover:bg-slate-800 hover:transition-all hover:duration-300 hover:ease-in-out cursor-pointer">
    ...
    <div className="flex items-center justify-between">
      <div className="bg-gray-700 text-xs px-2 py-1 rounded-2xl">{status}</div>
